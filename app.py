...
def save_interactive_visualization(fig):
    ...
    fig.write_html("backup.html", include_plotlyjs=True, full_html=True)

    # Now open the file, add our custom HTML, and save it again
    with open("backup.html", "r") as file:
    ...
    print("Interactive visualization with arrow navigation saved to 'backup.html'")
